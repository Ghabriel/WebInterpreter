...
define("core/Functions", ["require", "exports", "core/Program"], function (require, exports, Program_2) {
    "use strict";
    function print(value) {
        Program_2.Program.log("[PRINT] " + value + "\n");
    }
    exports.print = print;
});
define("core/Actions", ["require", "exports", "core/Errors", "core/Program", "core/Functions"], function (require, exports, Errors_1, Program_3, fn) {
    "use strict";
    function trace(program, name, value) {
        Program_3.Program.log("\t" + name + ": " + value + "\n");
    }
        ...
        function id(name) {
            return {
                execute: function (program) {
                    ...
                    program.pushValue(value);
                    Program_3.Program.log("variable retrieval:\n");
        ...
        function assignment(name, rhs, assignType) {
            return {
                execute: function (program) {
                    ...
                    Program_3.Program.log("assignment:\n");
        ...
        function operate(lhs, rhs, op) {
            return {
                execute: function (program) {
                    ...
                    Program_3.Program.log("operator:\n");
...
define("core/Settings", ["require", "exports"], function (require, exports) {
    "use strict";
    var Settings;
    (function (Settings) {
        Settings.SCOPE_ASCENDING_LOOKUP = true;
...
define("core/Program", ["require", "exports", "core/Settings", "core/SymbolTable"], function (require, exports, Settings_1, SymbolTable_1) {
    "use strict";
    var Program = (function () {
        ...
        Program.prototype.lookup = function (name) {
            var scopeIndex = this.symbolTables.length - 1;
            var data = this.symbolTables[scopeIndex].lookup(name);
            while (data === null && scopeIndex >= 0 && Settings_1.Settings.SCOPE_ASCENDING_LOOKUP) {
                scopeIndex--;
...
define("UI", ["require", "exports", "core/Program"], function (require, exports, Program_4) {
    "use strict";
    var UI = (function () {
        function UI(inputSel, outputSel, submitSel, parser) {
            ...
            this.parser = parser;
            var self = this;
            Program_4.Program.setLogger(function (text) {
...
define("Grammar", ["require", "exports", "core/Actions", "core/Program"], function (require, exports, Actions_1, Program_5) {
    "use strict";
    var ActionsWrapper = Actions_1.Actions;
    var ProgramWrapper = Program_5.Program;
    var Grammar;
    (function (Grammar) {
...
var o=function(k,v,o,l){for(o=o||{},l=k.length;l--;o[k[l]]=v);return o},$V0=[1,8],$V1=[1,10],$V2=[1,12,21],$V3=[1,12,17,21],$V4=[1,15],$V5=[1,24],$V6=[1,18],$V7=[1,19],$V8=[1,23],$V9=[1,22],$Va=[1,30],$Vb=[1,31],$Vc=[1,32],$Vd=[1,33],$Ve=[1,34],$Vf=[1,35],$Vg=[1,36],$Vh=[8,15,24,27,28,29,30,31,32,33],$Vi=[15,24],$Vj=[8,15,24,27,28,29],$Vk=[8,15,24,27,28,29,30,31],$Vl=[8,15,24,27,28,29,30,31,32],$Vm=[12,17,21];
var parser = {trace: function trace() { },
yy: {},
symbols_: {"error":2,"program":3,"exec_command_seq":4,"command":5,"command_seq":6,"normal_command":7,"T_EOC":8,"special_command":9,"var_assign":10,"fn_call":11,"T_IF":12,"(":13,"expr":14,")":15,"{":16,"}":17,"T_ELSE":18,"identifier":19,"assign":20,"T_ID":21,"T_ASSIGN":22,"rvalue_list":23,",":24,"T_REAL":25,"T_BOOL":26,"T_COMPARISON":27,"+":28,"-":29,"*":30,"/":31,"**":32,"%":33,"$accept":0,"$end":1},
terminals_: {2:"error",8:"T_EOC",12:"T_IF",13:"(",15:")",16:"{",17:"}",18:"T_ELSE",21:"T_ID",22:"T_ASSIGN",24:",",25:"T_REAL",26:"T_BOOL",27:"T_COMPARISON",28:"+",29:"-",30:"*",31:"/",32:"**",33:"%"},
productions_: [0,[3,1],[4,1],[4,2],[6,1],[6,2],[5,2],[5,1],[7,1],[7,1],[9,7],[9,11],[10,3],[19,1],[20,1],[11,4],[11,3],[23,1],[23,3],[14,1],[14,1],[14,1],[14,1],[14,3],[14,3],[14,3],[14,3],[14,3],[14,3],[14,3],[14,2],[14,2],[14,3]],
...
case 6: case 32:
 this.$ = $$[$0-1]; 
break;
case 7: case 8: case 9: case 22: case 31:
 this.$ = $$[$0]; 
break;
case 10:
...
table: [{3:1,4:2,5:3,7:4,9:5,10:6,11:7,12:$V0,19:9,21:$V1},{1:[3]},{1:[2,1],5:11,7:4,9:5,10:6,11:7,12:$V0,19:9,21:$V1},o($V2,[2,2]),{8:[1,12]},o($V3,[2,7]),{8:[2,8]},{8:[2,9]},{13:[1,13]},{13:$V4,20:14,22:[1,16]},o([8,13,15,22,24,27,28,29,30,31,32,33],[2,13]),o($V2,[2,3]),o($V3,[2,6]),{11:21,13:$V5,14:17,19:20,21:$V1,25:$V6,26:$V7,28:$V8,29:$V9},{11:21,13:$V5,14:25,19:20,21:$V1,25:$V6,26:$V7,28:$V8,29:$V9},{11:21,13:$V5,14:28,15:[1,27],19:20,21:$V1,23:26,25:$V6,26:$V7,28:$V8,29:$V9},o([13,21,25,26,28,29],[2,14]),{15:[1,29],27:$Va,28:$Vb,29:$Vc,30:$Vd,31:$Ve,32:$Vf,33:$Vg},o($Vh,[2,19]),o($Vh,[2,20]),o($Vh,[2,21],{13:$V4}),o($Vh,[2,22]),{11:21,13:$V5,14:37,19:20,21:$V1,25:$V6,26:$V7,28:$V8,29:$V9},{11:21,13:$V5,14:38,19:20,21:$V1,25:$V6,26:$V7,28:$V8,29:$V9},{11:21,13:$V5,14:39,19:20,21:$V1,25:$V6,26:$V7,28:$V8,29:$V9},{8:[2,12],27:$Va,28:$Vb,29:$Vc,30:$Vd,31:$Ve,32:$Vf,33:$Vg},{15:[1,40],24:[1,41]},o($Vh,[2,16]),o($Vi,[2,17],{27:$Va,28:$Vb,29:$Vc,30:$Vd,31:$Ve,32:$Vf,33:$Vg}),{16:[1,42]},{11:21,13:$V5,14:43,19:20,21:$V1,25:$V6,26:$V7,28:$V8,29:$V9},{11:21,13:$V5,14:44,19:20,21:$V1,25:$V6,26:$V7,28:$V8,29:$V9},{11:21,13:$V5,14:45,19:20,21:$V1,25:$V6,26:$V7,28:$V8,29:$V9},{11:21,13:$V5,14:46,19:20,21:$V1,25:$V6,26:$V7,28:$V8,29:$V9},{11:21,13:$V5,14:47,19:20,21:$V1,25:$V6,26:$V7,28:$V8,29:$V9},{11:21,13:$V5,14:48,19:20,21:$V1,25:$V6,26:$V7,28:$V8,29:$V9},{11:21,13:$V5,14:49,19:20,21:$V1,25:$V6,26:$V7,28:$V8,29:$V9},o($Vh,[2,30]),o($Vh,[2,31]),{15:[1,50],27:$Va,28:$Vb,29:$Vc,30:$Vd,31:$Ve,32:$Vf,33:$Vg},o($Vh,[2,15]),{11:21,13:$V5,14:51,19:20,21:$V1,25:$V6,26:$V7,28:$V8,29:$V9},{5:53,6:52,7:4,9:5,10:6,11:7,12:$V0,19:9,21:$V1},o([8,15,24,27],[2,23],{28:$Vb,29:$Vc,30:$Vd,31:$Ve,32:$Vf,33:$Vg}),o($Vj,[2,24],{30:$Vd,31:$Ve,32:$Vf,33:$Vg}),o($Vj,[2,25],{30:$Vd,31:$Ve,32:$Vf,33:$Vg}),o($Vk,[2,26],{32:$Vf,33:$Vg}),o($Vk,[2,27],{32:$Vf,33:$Vg}),o($Vl,[2,28],{33:$Vg}),o($Vl,[2,29],{33:$Vg}),o($Vh,[2,32]),o($Vi,[2,18],{27:$Va,28:$Vb,29:$Vc,30:$Vd,31:$Ve,32:$Vf,33:$Vg}),{5:55,7:4,9:5,10:6,11:7,12:$V0,17:[1,54],19:9,21:$V1},o($Vm,[2,4]),o($V3,[2,10],{18:[1,56]}),o($Vm,[2,5]),{16:[1,57]},{5:53,6:58,7:4,9:5,10:6,11:7,12:$V0,19:9,21:$V1},{5:55,7:4,9:5,10:6,11:7,12:$V0,17:[1,59],19:9,21:$V1},o($V3,[2,11])],
defaultActions: {6:[2,8],7:[2,9]},
